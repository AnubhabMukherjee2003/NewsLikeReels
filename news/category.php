...
// $sql= "SELECT * FROM `post` WHERE `category` LIKE '{$id}';";
...
foreach ($my_array as $x) {
    // SELECT * FROM `post` WHERE `category` LIKE 'sports' ORDER BY `post_id` DESC LIMIT 0,1;   
    $sql= "SELECT * FROM `post` WHERE `category` LIKE '{$id}' ORDER BY post_id DESC LIMIT {$x},1;";
    $result = mysqli_query($conn, $sql);
